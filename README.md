...
The [Py2EXE-wrapped Windows version](http://web.mit.edu/daigohji/projects/OOMMFTools/) is designed to be portable and free of external dependencies.

Everything necessary is included, including a binary of [FFmpeg](https://ffmpeg.org/) for OOMMFConvert. 

The script otherwise has the following dependencies:
...
3. Set correct path to OOMMF in avf2bmp.py and oommf.bat
4. Set correct path to tcl in avf2bmp.py and oommf.bat
...
License
=======
This code is licensed under teh GNU GNU General Public License version 2. See License.txt for more details.
